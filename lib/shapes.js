...
class Circle extends Shape {
    render() {
        return `<svg xmlns="http://www.w3.org/2000/svg" class="circle"
            width="300"
            height="200"
...
class Square extends Shape {
    render() {
        return `<svg xmlns="http://www.w3.org/2000/svg" class="square"
            width="300"
            height="200"
            viewBox="-100 -100 200 200">
...
class Triangle extends Shape {
    render() {
        return `<svg xmlns="http://www.w3.org/2000/svg" class="triangle"
            width="300"
            height="200"
            viewBox="-100 -100 200 200">
